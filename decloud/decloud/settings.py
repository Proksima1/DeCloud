...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv(Envs.POSTGRES_DB_NAME.value, "decloud"),
        "USER": os.getenv(Envs.POSTGRES_DB_USER.value, "postgres"),
        "PASSWORD": os.getenv(Envs.POSTGRES_DB_PASSWORD.value, "postgres"),
        "HOST": os.getenv(Envs.POSTGRES_DB_HOST.value, "localhost"),
        "PORT": os.getenv(Envs.POSTGRES_DB_PORT.value, "5432"),
    }
}
